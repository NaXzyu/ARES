...
from ..hooks.hook_type import HookType
...
class HookManager:
    ...
    HOOK_EXECUTION_ORDER = [
        ...
        HookType.CYTHON_MODULES   # Cython modules loaded last
    ]
    ...
    def get_hook_pyinstaller_name(cls, hook_type):
        ...
        """
        # Simply extract the module name before _hook.py and create a PyInstaller hook name
        # For example, converts "sdl2_hook.py" to "hook-sdl2.py"
        filename = hook_type.value
        # Standard naming convention: xxx_hook.py -> hook-xxx.py
    ...
    def get_runtime_hooks(cls, hooks_path=None):
        ...
        # Create list of hook file paths in the defined execution order
        runtime_hooks = []
    ...
    def create_basic_runtime_hooks(cls, output_dir):
        ...
        # For basic hooks, we only need SDL2 and Cython modules
        basic_hook_types = [HookType.SDL2, HookType.CYTHON_MODULES]
